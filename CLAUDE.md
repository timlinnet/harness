...
- `FIRST_PRINCIPLES.md` — the canonical: 18 principles, 16 strategic positions, the Questioning Framework, the Canyon Model, the Decision Template, the Epistemic Stance.
